...
Source Server         : World of Warcraft Mist of Pandaria
...
-- ----------------------------
-- Table structure for account_achievement_criteria_progress
-- ----------------------------
...
-- ----------------------------
-- Table structure for account_achievement_criteria_progress_v2
-- ----------------------------
...
-- ----------------------------
-- Table structure for account_battle_pet_declinedname
-- ----------------------------
...
-- ----------------------------
-- Table structure for account_mount
-- ----------------------------
DROP TABLE IF EXISTS `account_mount`;
CREATE TABLE `account_mount` (
  `account` bigint(10) unsigned NOT NULL,
  `spellid` int(10) unsigned NOT NULL,
  `racemask` bigint(10) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`account`,`spellid`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `account_spell` (
  `account` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Global Unique Identifier',
...
CREATE TABLE `arena_games` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Identifier of a player''s data of a single arena',
  `arenaType` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT 'RankedType enum',
  ...
  `killingBlows` int(10) unsigned NOT NULL DEFAULT '0',
  `deaths` int(10) unsigned NOT NULL DEFAULT '0',
  `personalRating` smallint(5) unsigned NOT NULL DEFAULT '0',
  `personalRatingChange` smallint(6) NOT NULL DEFAULT '0',
  `mmrRating` smallint(5) unsigned NOT NULL DEFAULT '0',
  `mmrRatingChange` smallint(6) NOT NULL DEFAULT '0',
  `map` varchar(50) NOT NULL DEFAULT '0' COMMENT 'Name of the map where the arena is played',
  PRIMARY KEY (`id`,`characterGuid`,`arenaType`,`startDate`,`endDate`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
-- ----------------------------
-- Table structure for battle_pet_item_data
-- ----------------------------
...
-- ----------------------------
-- Table structure for boss_log
-- ----------------------------
DROP TABLE IF EXISTS `boss_log`;
CREATE TABLE `boss_log` (
  `id` int(11) DEFAULT NULL,
  `boss_entry` int(11) DEFAULT NULL,
  `difficulty` int(11) DEFAULT NULL,
  `map_id` int(11) DEFAULT NULL,
  `guild_id` int(11) DEFAULT NULL,
  `faction` int(11) DEFAULT NULL,
  `members` int(11) DEFAULT NULL,
  `instance_progress` int(11) DEFAULT NULL,
  `max_boss_num` int(11) DEFAULT NULL,
  `wipes` int(11) DEFAULT NULL,
  `time` int(11) DEFAULT NULL,
  `kill_date` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
-- ----------------------------
-- Table structure for characters_boss_looted
-- ----------------------------
...
-- ----------------------------
-- Table structure for character_achievement_criteria_progress
-- ----------------------------
...
-- ----------------------------
-- Table structure for character_achievement_criteria_progress_v2
-- ----------------------------
...
-- ----------------------------
-- Table structure for character_archeo_active_zone
-- ----------------------------
DROP TABLE IF EXISTS `character_archeo_active_zone`;
CREATE TABLE `character_archeo_active_zone` (
  `guid` int(11) NOT NULL COMMENT 'GUID du personnage',
  `site` int(11) NOT NULL COMMENT 'Id du site',
  `slot` int(11) NOT NULL COMMENT 'Slot [0;15]',
  `artifactDiscovered` tinyint(3) NOT NULL,
  UNIQUE KEY `guid` (`guid`,`slot`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='Sauvegarde les zones d''archeologies des joueurs';

-- ----------------------------
-- Table structure for character_archeo_artifacts_history
-- ----------------------------
DROP TABLE IF EXISTS `character_archeo_artifacts_history`;
CREATE TABLE `character_archeo_artifacts_history` (
  `guid` int(11) NOT NULL COMMENT 'GUID du personnage',
  `project` int(11) NOT NULL COMMENT 'ID dans ResearchProject.dbc',
  `date` int(11) NOT NULL COMMENT 'Date de la dernière reconstruction',
  `nbOfReconstruct` int(11) NOT NULL,
  UNIQUE KEY `guid` (`guid`,`project`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

-- ----------------------------
-- Table structure for character_archeo_research_project
-- ----------------------------
DROP TABLE IF EXISTS `character_archeo_research_project`;
CREATE TABLE `character_archeo_research_project` (
...
-- ----------------------------
-- Table structure for character_battleground_holiday
-- ----------------------------
DROP TABLE IF EXISTS `character_battleground_holiday`;
CREATE TABLE `character_battleground_holiday` (
  `guid` int(10) unsigned NOT NULL,
  PRIMARY KEY (`guid`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
-- ----------------------------
-- Table structure for character_charges_cooldown
-- ----------------------------
...
-- ----------------------------
-- Table structure for character_quest_choice
-- ----------------------------
DROP TABLE IF EXISTS `character_quest_choice`;
CREATE TABLE `character_quest_choice` (
  `guid` int(10) NOT NULL,
  `questChoice` int(10) NOT NULL,
  PRIMARY KEY (`guid`,`questChoice`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- ----------------------------
-- Table structure for character_quest_currency
-- ----------------------------
...
-- ----------------------------
-- Table structure for character_quest_pool
-- ----------------------------
DROP TABLE IF EXISTS `character_quest_pool`;
CREATE TABLE `character_quest_pool` (
  `guid` int(10) NOT NULL,
  `questPool` int(10) NOT NULL,
  `count` int(10) NOT NULL,
  PRIMARY KEY (`guid`,`questPool`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- ----------------------------
-- Table structure for character_raid
-- ----------------------------
...
-- ----------------------------
-- Table structure for character_ranked_caps
-- ----------------------------
DROP TABLE IF EXISTS `character_ranked_caps`;
CREATE TABLE `character_ranked_caps` (
  `guid` int(10) NOT NULL,
  `arenaCap` int(10) unsigned NOT NULL,
  `bgCap` int(10) unsigned NOT NULL,
  `randomCap` int(10) unsigned NOT NULL,
  `ptToCatch` int(10) unsigned NOT NULL,
  PRIMARY KEY (`guid`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- ----------------------------
-- Table structure for character_ranked_stats
-- ----------------------------
DROP TABLE IF EXISTS `character_ranked_stats`;
CREATE TABLE `character_ranked_stats` (
  `guid` int(10) NOT NULL,
  `slot` tinyint(3) unsigned NOT NULL,
  `weekGames` smallint(5) unsigned NOT NULL,
  `weekWins` smallint(5) unsigned NOT NULL,
  `weekBestRating` smallint(5) unsigned NOT NULL,
  `seasonGames` smallint(5) unsigned NOT NULL,
  `seasonWins` smallint(5) unsigned NOT NULL,
  `seasonBestRating` smallint(5) unsigned NOT NULL,
  `personalRating` smallint(5) unsigned NOT NULL,
  `mmrRating` smallint(5) unsigned NOT NULL,
  PRIMARY KEY (`guid`,`slot`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
-- ----------------------------
-- Table structure for character_spell_copy
-- ----------------------------
DROP TABLE IF EXISTS `character_spell_copy`;
CREATE TABLE `character_spell_copy` (
  `guid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Global Unique Identifier',
  `spell` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT 'Spell Identifier',
  `active` tinyint(3) unsigned NOT NULL DEFAULT '1',
  `disabled` tinyint(3) unsigned NOT NULL DEFAULT '0',
...
-- ----------------------------
-- Table structure for character_talent_copy
-- ----------------------------
DROP TABLE IF EXISTS `character_talent_copy`;
CREATE TABLE `character_talent_copy` (
  `guid` int(10) unsigned NOT NULL,
  `spell` mediumint(8) unsigned NOT NULL,
  `spec` tinyint(3) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`guid`,`spell`,`spec`)
...
CREATE TABLE `character_warn` (
  ...
  `gamemaster` varchar(50) DEFAULT NULL COMMENT 'Nom du MJ qui a donne l''avertissement',
...
CREATE TABLE `fake_players` (
  ...
  `levelTime` int(10) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Simulation joueurs en ligne';
...
-- ----------------------------
-- Table structure for guild_achievement_criteria_progress
-- ----------------------------
...
-- ----------------------------
-- Table structure for guild_achievement_criteria_progress_v2
-- ----------------------------
...
-- ----------------------------
-- Table structure for guild_challenge
-- ----------------------------
...
CREATE TABLE `guild_member` (
  ...
  `firstprofflevel` int(10) unsigned NOT NULL DEFAULT '0',
  `firstproffskill` int(10) unsigned NOT NULL DEFAULT '0',
  `firstproffrank` int(10) unsigned NOT NULL DEFAULT '0',
  `secondprofflevel` int(10) unsigned NOT NULL DEFAULT '0',
  `secondproffskill` int(10) unsigned NOT NULL DEFAULT '0',
  `secondproffrank` int(10) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE `guild_member_withdraw` (
  ...
  `tab6` int(10) unsigned NOT NULL,
  `tab7` int(10) unsigned NOT NULL,
...
CREATE TABLE `log_faction_change` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=3810 DEFAULT CHARSET=latin1;
...
CREATE TABLE `time_diff_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=714988 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Table structure for vip_items
-- ----------------------------
...
-- ----------------------------
-- Table structure for webshop_delivery_gold
-- ----------------------------
...
-- ----------------------------
-- Table structure for webshop_delivery_level
-- ----------------------------
...
-- ----------------------------
-- Table structure for webshop_delivery_profession
-- ----------------------------
DROP TABLE IF EXISTS `webshop_delivery_profession`;
CREATE TABLE `webshop_delivery_profession` (
  `guid` int(10) NOT NULL,
  `skill` mediumint(8) NOT NULL,
  `recipe` mediumint(8) NOT NULL,
  `transaction` int(10) NOT NULL,
  `delivery` tinyint(1) NOT NULL,
  PRIMARY KEY (`guid`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
