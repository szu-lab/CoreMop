...
void LoginDatabaseConnection::DoPrepareStatements()
{
    ...
    PREPARE_STATEMENT(LOGIN_DEL_ACCOUNT_REP_MODS, "DELETE FROM account_rep_mods WHERE id = ?", CONNECTION_ASYNC);
    PREPARE_STATEMENT(LOGIN_REP_ACCOUNT_REP_MODS, "REPLACE INTO account_rep_mods (id, reputationId, modifier) VALUES (?, ?, ?)", CONNECTION_ASYNC);
    PREPARE_STATEMENT(LOGIN_SEL_ACCOUNT_REP_MODS, "SELECT reputationId, modifier FROM account_rep_mods WHERE id = ?", CONNECTION_SYNCH);
}
