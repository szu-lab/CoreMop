...
enum Spells
{
    ...
    SPELL_DWARVEN_CHAIN_LIGHTNING    = 80646, //穽設嶢?
...
public:
    ...
    struct npc_golem_sentryAI : public ScriptedAI
    {
        ...
        void EnterCombat(Unit* who)
        {
            ...
            GetCreatureListWithEntryInGrid(_golems, me, NPC_GOLEM_SENTRY, 200.0f); // TODO: adjuste searche range
...
public:
    ...
    struct npc_drakonid_drudgeAI : public ScriptedAI
    {
        ...
        void JustDied(Unit* who)
        {
            ...
            GetCreatureListWithEntryInGrid(_drudges, me, NPC_GOLEM_SENTRY, 200.0f); // TODO: adjuste searche range
