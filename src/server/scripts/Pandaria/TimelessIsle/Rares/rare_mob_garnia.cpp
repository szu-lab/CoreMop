...
class rare_mob_garnia : public CreatureScript
{
    public:
        rare_mob_garnia() : CreatureScript("rare_mob_garnia") { }

        struct rare_mob_garniaAI : public BossAI
        {
            rare_mob_garniaAI(Creature* creature) : BossAI(creature, 0) { }
        ...
        {
            return new rare_mob_garniaAI(creature);
        }
};
