...
class rare_mob_zesqua : public CreatureScript
{
    public:
        rare_mob_zesqua() : CreatureScript("rare_mob_zesqua") { }

        struct rare_mob_zesquaAI : public BossAI
        {
            rare_mob_zesquaAI(Creature* creature) : BossAI(creature, 0) { }
        ...
        {
            return new rare_mob_zesquaAI(creature);
        }
};
