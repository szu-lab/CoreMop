...
#include "Player.h"
#include "Pet.h"
#include "boss_garrosh_hellscream.hpp"
...
public:
    ...
    bool Execute(uint64 /*currTime*/, uint32 /*diff*/)
    {
        ...
        if (InstanceScript* m_Instance = obj->GetInstanceScript())
        {
            ...
            {
                // Yshaaraj Poop
                if (Creature * l_GarroshHellScream = m_Instance->instance->GetCreature(m_Instance->GetData64(DATA_GARROSH_HEART_OF_YSHAARAJ)))
                {
...
public:
    ...
    struct boss_garrosh_hellscreamAI : public BossAI
    {
        ...
        void JustReachedHome() override
        {
            ...
            uint32 l_Entry[7] = { GarroshCreatures::CREATURE_ANNHLIATE_TRIGGER, GarroshCreatures::CREATURE_DESECRATED_WERAPON_TRIGGER, GarroshCreatures::CREATURE_FARSEER_WOLF_RIDER, GarroshCreatures::CREATURE_VICIOUS_WAR_WOLF, GarroshCreatures::CREATURE_KORKRON_WARBRINGER, GarroshCreatures::CREATURE_SIEGE_ENGINEER, GarroshCreatures::CREATURE_MINION_YSHAARJ };
            ...
            if (m_Instance)
            {
                m_Instance->SetBossState(DATA_GARROSH_HELLSCREAM, EncounterState::FAIL);
        ...
        void HandleHallsDoorsAcitvation()
        {
            ...
            me->GetGameObjectListWithEntryInGrid(l_ListGameObjects, GarroshGameobjects::GAMEOBJECT_ENTRANCE, 1000.0f);
        ...
        void DoAction(const int32 action) override
        {
            ...
            case Actions::ACTION_TELEPORT:
            {
                if (Creature* l_Heart = m_Instance->instance->GetCreature(m_Instance->GetData64(DATA_GARROSH_HEART_OF_YSHAARAJ)))
                {
                    if (l_Heart->AI())
                    {
                            ...
                            DespawnCreaturesInArea(GarroshCreatures::CREATURE_KORKRON_IRON_STAR, me);
                            DespawnCreaturesInArea(GarroshCreatures::CREATURE_FARSEER_WOLF_RIDER, me);
                            DespawnCreaturesInArea(GarroshCreatures::CREATURE_KORKRON_WARBRINGER, me);

                            RespawnCreatures(GarroshCreatures::CREATURE_EMBODIED_FEAR, me);
                            RespawnCreatures(GarroshCreatures::CREATURE_EMBODIED_DOUBT, me);
                            RespawnCreatures(GarroshCreatures::CREATURE_EMBODIED_DESPAIR, me);
                            ...
                            me->SummonCreature(GarroshCreatures::CREATURE_AURA_OF_YSHAARAJ, me->GetPositionX(), me->GetPositionY(), me->GetPositionZ(), me->GetOrientation(), TEMPSUMMON_MANUAL_DESPAWN);
                            me->SetCanFly(false);
                            ...
                            case Locations::LOCATION_TERRACE_OF_ENDLESS_SPRINGS:
                                ...
                                me->GetCreatureListWithEntryInGrid(m_ListCreatures, GarroshCreatures::CREATURE_EMBODIED_DOUBT, 1000.0f);
                                break;
                            ...
                            case Locations::LOCATION_RED_CRANE:
                                ...
                                me->GetCreatureListWithEntryInGrid(m_ListCreatures, GarroshCreatures::CREATURE_EMBODIED_DESPAIR, 1000.0f);
                                break;
                            }
                            ...
                            // Reset Walls
                            std::list<GameObject*> l_ListGameObjects;
                            me->GetGameObjectListWithEntryInGrid(l_ListGameObjects, GarroshGameobjects::GAMEOBJECT_GARROSH_ENCOUNTER_SHA_VORTEX_COLLISION, 1000.0f);
            ...
            case Actions::ACTION_EMBODIED_COUNT_DEATH:
            {
                ...
                {
                    // Yshaaraj Poop
                    if (Creature * l_HeartOfYshaarajTrigger = m_Instance->instance->GetCreature(m_Instance->GetData64(DATA_GARROSH_HEART_OF_YSHAARAJ)))
                    {
                    ...
                    DespawnCreaturesInArea(GarroshCreatures::CREATURE_AURA_OF_YSHAARAJ, me);
        ...
        void SummonKorkronSoldiers()
        {
            ...
            if (GameObject * l_RightDoor = m_Instance->instance->GetGameObject(m_Instance->GetData64(DATA_RIGHT_DOOR_GARROSH)))
            {
                if (GameObject * l_LeftDoor = m_Instance->instance->GetGameObject(m_Instance->GetData64(DATA_LEFT_DOOR_GARROSH)))
                {
                    ...
                    for (int i = 0; i < 3; i++)
                    {
                        Creature* l_Korkron = me->SummonCreature(GarroshCreatures::CREATURE_KORKRON_WARBRINGER, l_PositionLeftDoor.GetPositionX() + frand(1.5f, 3.0f), l_PositionLeftDoor.GetPositionY() + frand(1.5f, 3.0f), l_PositionLeftDoor.GetPositionZ(), l_PositionLeftDoor.GetOrientation(), TEMPSUMMON_MANUAL_DESPAWN);
                    ...
                    for (int i = 0; i < 3; i++)
                    {
                        Creature* l_Korkron = me->SummonCreature(GarroshCreatures::CREATURE_KORKRON_WARBRINGER, l_PositionRightDoor.GetPositionX() + frand(1.5f, 3.0f), l_PositionRightDoor.GetPositionY() + frand(1.5f, 3.0f), l_PositionRightDoor.GetPositionZ(), l_PositionRightDoor.GetOrientation(), TEMPSUMMON_MANUAL_DESPAWN);
            ...
            if (GameObject * l_RightDoor = m_Instance->instance->GetGameObject(m_Instance->GetData64(DATA_RIGHT_DOOR_GARROSH)))
            {
                if (GameObject * l_LeftDoor = m_Instance->instance->GetGameObject(m_Instance->GetData64(DATA_LEFT_DOOR_GARROSH)))
                {
                    ...
                    case 0:
                    {
                        ...
                        Creature* l_Farseer = me->SummonCreature(GarroshCreatures::CREATURE_FARSEER_WOLF_RIDER, l_PositionLeftDoor.GetPositionX(), l_PositionLeftDoor.GetPositionY(), l_PositionLeftDoor.GetPositionZ(), l_PositionLeftDoor.GetOrientation(), TEMPSUMMON_MANUAL_DESPAWN);
                    ...
                    case 1:
                    {
                        ...
                        Creature* l_Farseer = me->SummonCreature(GarroshCreatures::CREATURE_FARSEER_WOLF_RIDER, l_PositionRightDoor.GetPositionX(), l_PositionRightDoor.GetPositionY(), l_PositionRightDoor.GetPositionZ(), l_PositionRightDoor.GetOrientation(), TEMPSUMMON_MANUAL_DESPAWN);
        ...
        void IntermissionRandomSayings(const uint32 diff)
        {
            ...
            if (l_NearestHearth = me->FindNearestCreature(GarroshCreatures::CREATURE_HEART_OF_YSHAARAJ, 100.0f, true))
            {
                if (m_IntermissionActive)
                {
        ...
        void UpdateAI(const uint32 diff) override
        {
            ...
            case Events::EVENT_ENGINEERS:
            {
                ...
                DespawnCreaturesInArea(GarroshCreatures::CREATURE_KORKRON_IRON_STAR, me);
                DespawnCreaturesInArea(GarroshCreatures::CREATURE_STAR_EXPLOSIVE_TRIGGER, me);
            ...
            case Events::EVENT_ENGINEERS + 1:
                ...
                for (int i = 0; i < 2; i++)
                {
                    Creature* l_Engineer = me->SummonCreature(GarroshCreatures::CREATURE_SIEGE_ENGINEER, l_PositionEngineers[i], TEMPSUMMON_MANUAL_DESPAWN);
                    ...
                    Creature* l_IronStar = l_Engineer->SummonCreature(GarroshCreatures::CREATURE_KORKRON_IRON_STAR, l_PositionIronStars[i], TEMPSUMMON_MANUAL_DESPAWN);
            ...
            case Events::EVENT_PORT_TO_GARROSH_HALL:
            {
                ...
                {
                case Locations::LOCATION_TERRACE_OF_ENDLESS_SPRINGS:
                    AttackStop(GarroshCreatures::CREATURE_EMBODIED_FEAR, me);
                    break;
                case Locations::LOCATION_RED_CRANE:
                    AttackStop(GarroshCreatures::CREATURE_EMBODIED_DESPAIR, me);
                    break;
                case Locations::LOCATION_JADE_TEMPLE:
                    AttackStop(GarroshCreatures::CREATURE_EMBODIED_DOUBT, me);
                    break;
                }
...
public:
    ...
    class spell_whirling_corruptionAuraScript : public AuraScript
    {
        ...
        void HandlePeriodic(const AuraEffect* aurEff)
        {
...
public:
    ...
    private:
        ...
        void Register()
        {
            ...
            OnEffectUpdate += AuraEffectUpdateFn(spell_touch_of_yshaaraj_proc_twoAuraScript::OnUpdate, EFFECT_6, SPELL_AURA_OVERRIDE_AUTOATTACK_WITH_MELEE_SPELL);
        }
    };
...
public:
    ...
    class spell_empowering_corruption_filter_SpellScript : public SpellScript
    {
        ...
        void FilterTargets(std::list<WorldObject*>& targets)
        {
            ...
            GetCaster()->GetCreatureListWithEntryInGrid(l_TempoListCreatures, GarroshCreatures::CREATURE_MINION_YSHAARJ, 2.0f);
...
public:
    ...
    struct siege_of_orgrimmar_creaturesAI : public ScriptedAI
    {
        ...
        void JustDied(Unit* killer) override
        {
            ...
            // Ultimate Despair
            if (Creature* l_Despair = me->FindNearestCreature(GarroshCreatures::CREATURE_EMBODIED_DESPAIR, 100.0f, true))
    ...
    struct siege_of_orgrimmar_creaturesAI : public ScriptedAI
    {
        ...
        void DoAction(const int32 action) override
        {
            switch (action)
            {
                ...
                {
                    Creature* l_Temp = me->SummonCreature(GarroshCreatures::CREATURE_STAR_EXPLOSIVE_TRIGGER, 1037.116f, -5737.422f, -317.671f, me->GetOrientation(), TEMPSUMMON_MANUAL_DESPAWN);
                ...
                {
                    Creature* l_Temp = me->SummonCreature(GarroshCreatures::CREATURE_STAR_EXPLOSIVE_TRIGGER, 1109.485f, -5543.685f, -317.671f, me->GetOrientation(), TEMPSUMMON_MANUAL_DESPAWN);
        ...
        void UpdateAI(const uint32 diff) override
        {
            ...
            if (m_Activated)
            {
                ...
                if (m_PDiff <= diff)
                {
                    ...
                    me->GetCreatureListWithEntryInGrid(l_ListCreatures, GarroshCreatures::CREATURE_KORKRON_WARBRINGER, 24.0f);
                    me->GetCreatureListWithEntryInGrid(l_ListCreatures, GarroshCreatures::CREATURE_FARSEER_WOLF_RIDER, 24.0f);
