    ...
    public:
        ...
        struct boss_garajalAI : public BossAI
        {
            ...
            void JustDied(Unit* attacker)
            {
                ...
                m_Instance->DoCompleteAchievement(IsHeroic() ? ACHIEVEMENT_HEROIC_GARAJAL : ACHIEVEMENT_GUARDIANS_OF_MOGU_SHAN);
...
{
    new boss_garajal();             ///< 60143
    new mob_garajal_ghost();        ///< 61140
    new mob_spirit_totem();         ///< 60240
    new mob_shadowy_minion();       ///< 60184 - 60940
    new mob_soul_cutter();          ///< 62003
    new mob_spirit_totem_intro();   ///< 60512 - 60513
    new spell_soul_back();          ///< 120715
    new spell_final_destination();  ///< 118469
    new spell_voodoo_doll();        ///< 122151
}
