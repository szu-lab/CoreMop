...
enum TrinityStrings
{
    ...
    LANG_COMMAND_CANNT_BE_PROCESSED     = 66,
...
//  LANG_BG_EY_START_TWO_MINUTES        = 755, - defined above
    ...
    // Spectator
    LANG_SPECTATOR_PLAYER_NOT_FOUND     = 11050,
    LANG_SPECTATOR_TARGET_IS_SPECTATOR  = 11051,
    LANG_SPECTATOR_CANT_TELEPORT_SELF   = 11052,
    LANG_SPECTATOR_YOU_IN_COMBAT        = 11053,
    LANG_SPECTATOR_YOU_ARE_DEAD         = 11054,
    LANG_SPECTATOR_HIDE_PET             = 11055,
    LANG_SPECTATOR_IN_BG_ARENA          = 11056,
    LANG_SPECTATOR_IN_QUEUE             = 11057,
    LANG_SPECTATOR_TARGET_NOT_IN_ARENA  = 11058,
    LANG_SPECTATOR_IN_FLIGHT            = 11059,
    LANG_SPECTATOR_BG_NOT_FOUND         = 11060,
    LANG_SPECTATOR_BG_NOT_STARTED       = 11061,
    LANG_SPECTATOR_RATED_ARENA          = 11062,
    LANG_SPECTATOR_TEAMS                = 11063,
    LANG_SPECTATOR_NOT_SPECTATOR        = 11064,
    LANG_SPECTATOR_CANNT_SEE            = 11065,
    LANG_SPECTATOR_CANT_USE_EMOTE       = 11066,

    LANG_ANTICHEAT                      = 11067,

    // Piligrims Bounty
    LANG_THE_THUKINATOR_10              = 11103,
    LANG_THE_THUKINATOR_20              = 11104,
    LANG_THE_THUKINATOR_30              = 11105,
    LANG_THE_THUKINATOR_40              = 11106,
    ...
    // InterRealm messages (reserved: 13105-13300)
    ...
    LANG_INTERREALM_BAN_PLAYER_RESPONSE_OK  = 13113,
    LANG_INTERREALM_BAN_PLAYER_RESPONSE_REALM_NOT_FOUND = 13114,
    LANG_INTERREALM_BAN_PLAYER_RESPONSE_WRONG_NAME      = 13115,
    LANG_INTERREALM_BAN_PLAYER_RESPONSE_WRONG_REASON    = 13116,
    LANG_INTERREALM_BAN_PLAYER_RESPONSE_WRONG_GMNAME    = 13117,
    LANG_INTERREALM_BAN_PLAYER_RESPONSE_WRONG_DURATION  = 13118,

    // class remider notifications (reserved: 13301-13400)
    LANG_YOUR_QUESTS_REPAIRED      = 13301,

    LangTauntFlag  = 20002,

    // NOT RESERVED IDS                   13400-1999999999
