...
enum SpellAttr10
{
    ...
    SPELL_ATTR10_SYMBIOSIS                        = 0x00008000, // 15
...
enum SpellHitType
{
    ...
    SPELL_HIT_TYPE_SPLIT_DAMAGE        = 0x00008,
    SPELL_HIT_TYPE_CASTER_IS_TARGET    = 0x00010,   // replace caster?
...
{
    SPELL_PREVENTION_TYPE_SILENCE   = 0x1,
    SPELL_PREVENTION_TYPE_PACIFY    = 0x2,
    SPELL_PREVENTION_TYPE_UNK1      = 0x4
};
...
enum SkillType
{
    ...
    SKILL_APPRENTICE_COOKING       = 981, // New in MoP 5.0.5 (cooking) test
    SKILL_JOURNEYMAN_COOKBOOK      = 982, // New in MoP 5.0.5 (cooking) test
