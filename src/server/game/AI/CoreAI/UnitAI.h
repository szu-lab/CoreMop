...
class UnitAI
{
    ...
    public:
        ...
        virtual void SetFloatData(uint32 id, float value) { }
        virtual float GetFloatData(uint32 id) { return 0.0f; }
        ...
        void DoCastRandom(uint32 spellId, float dist, bool triggered = false, int32 aura = 0, uint32 position = 0); // Players only
