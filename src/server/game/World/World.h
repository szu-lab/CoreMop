...
#define ITEM_SCALING_PVP_ITEM_LEVEL_MIN 0 // Not needed in MoP
#define ITEM_SCALING_PVP_ITEM_LEVEL_MAX 540 // Should exclude pvp gear
#define ITEM_SCALING_CHALLENGE_MODE_ITEM_LEVEL_MAX 463
...
enum WorldBoolConfigs
{
    ...
    CONFIG_ANTICHEAT_GAMEMASTER_REPORT,
    ...
    CONFIG_PERMANENT_USABLE_ITEMS,
    CONFIG_TRANSMOGRIFY_LEGENDARY_ENABLED,
...
enum WorldFloatConfigs
{
    ...
    CONFIG_ANTICHEAT_AUTOBAN_AVERAGE_REPORTS,
...
enum WorldIntConfigs
{
    ...
    CONFIG_ANTICHEAT_TELEPORTHACKDETECTION_REPORTS_INGAME_NOTIFICATION,
    CONFIG_ANTICHEAT_AUTOBAN_TOTAL_REPORTS,
    CONFIG_ANTICHEAT_AUTOBAN_TELEPORT_HACK_TOTAL_REPORTS,
    CONFIG_ANTICHEAT_AUTOBAN_MAX_PING,
    CONFIG_ANTICHEAT_AUTOBAN_DURATION,
    ...
    CONFIG_TRANSMOGRIFY_LEGENDARY_COST,
    CONFIG_SKILL_GAIN_CRAFTING_LIMIT,
    CONFIG_SKILL_GAIN_GATHERING_LIMIT,
    CONFIG_SKILL_CHANCE_ORANGE_LIMIT,
    CONFIG_SKILL_CHANCE_YELLOW_LIMIT,
    CONFIG_SKILL_CHANCE_GREEN_LIMIT,
    CONFIG_SKILL_CHANCE_GREY_LIMIT,
...
enum Rates
{
    ...
    RATE_XP_KILL_LIMIT,
    RATE_XP_QUEST_LIMIT,
    RATE_REPUTATION_GAIN_LIMIT,
    RATE_REPUTATION_LOWLEVEL_KILL_LIMIT,
    RATE_REPUTATION_LOWLEVEL_QUEST_LIMIT,
    MAX_RATES
};
...
enum RateType
{
    ...
    ReputationGain,
    ReputationLowLevelKill,
    ReputationLowLevelQuest,
...
enum ScriptCommands
{
    ...
    SCRIPT_COMMAND_DESPAWN_CREATURE      = 35,               // source = WorldObject (summoner), datalong = creature entry, datalong2 = despawn delay
};
...
class World
{
    public:
        ...
        void SendGMText(const char* text);
        ...
        void AddCharacterInfo(uint32 guid, uint32 accountId, std::string const& name, uint8 gender, uint8 race, uint8 playerClass, uint8 level);
